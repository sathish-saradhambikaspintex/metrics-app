  ...
  constructor(props) {
    ...
    this.state = {
      items: [
        ...
        {
          displayName: "SHEET 02",
          name: "sheet_02",
          createdAt: "2017-12-12T09:38:38.710Z",
          modifiedAt: "2017-12-23T03:48:30.530Z"
        },
        {
          displayName: "SHEET 03",
          name: "sheet_03",
          createdAt: "2017-12-12T09:38:38.710Z",
          modifiedAt: "2017-12-23T03:48:30.530Z"
        },
        {
          displayName: "SHEET 04",
          name: "sheet_04",
          createdAt: "2017-12-12T09:38:38.710Z",
          modifiedAt: "2017-12-23T03:48:30.530Z"
        },
        {
          displayName: "SHEET 05",
          name: "sheet_05",
          createdAt: "2017-12-12T09:38:38.710Z",
          modifiedAt: "2017-12-23T03:48:30.530Z"
        }
    ...
    return (
      <Layout.Row key="menu" divider sticky={{ top: 50 }}>
        ...
        <Button.Minimal
          ...
          onClick={pushRoute("/app/analytics/sheets/create")}
        />
        <Popover position="bottom-end">
          ...
          <Menu>
            ...
            />
            <Menu.Item icon="trash" text="Delete Sheet(s)" onClick={""} />
          </Menu>
        </Popover>
      </Layout.Row>
    );
