...
class PlaceHolder extends AbstractPlaceHolder {
	renderPlaceHolder() {
		...
		const inputElement = isArrayType ? (
			<Controls.Input.Multiple type="number" leftElement="000.." readOnly {...inputProps} />
		) : (
			<Controls.Input type="number" leftElement="000.." readOnly {...inputProps} />
		);
...
const TagIcon = <Tag.Icon key="double-tag" id="double" iconText="000.." text="Double" />;
