...
class PlaceHolder extends AbstractPlaceHolder {
	renderPlaceHolder() {
		...
		const inputElement = isArrayType ? (
			<Controls.Input.Multiple type="number" leftElement="00" readOnly {...inputProps} />
		) : (
			<Controls.Input type="number" leftElement="00" readOnly {...inputProps} />
		);
...
const TagIcon = <Tag.Icon key="int-tag" id="int" iconText="00" text="Integer" />;
